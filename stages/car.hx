var mainVid:PsychVideoSprite;
var missVid:PsychVideoSprite;

function onLoad() 
{
    missVid = new PsychVideoSprite();
    ...
    missVid.load(Paths.video('CarVideoMissing'),[PsychVideoSprite.muted]);
    add(missVid);

    mainVid = new PsychVideoSprite();
    ...
    mainVid.load(Paths.video('CarVideo'),[PsychVideoSprite.muted]);
    add(mainVid);
}
